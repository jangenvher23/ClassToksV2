...
{
    public class CropFragment : AndroidX.Fragment.App.Fragment, CropImageView.IOnSetImageUriCompleteListener, CropImageView.IOnCropImageCompleteListener
    {
        ...
        public void UpdateCurrentCropViewOptions()
        {
            ...
            ((CropImageActivity)Activity).SetCurrentOptions(options);
        }
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            {
                _cropImageView.SetImageUriAsync(Android.Net.Uri.Parse(Settings.ImageBrowseCrop));
        ...
        public override void OnAttach(Context context)
        {
            ...
            ((CropImageActivity)context).SetCurrentFragment(this);
        }
