...
namespace ClassToksV2.Views
{
    ...
    {
        private readonly StackLayout _contentHolder;

        public XNFlipView()
        {
            _contentHolder = new StackLayout() { HorizontalOptions = LayoutOptions.Fill, VerticalOptions = LayoutOptions.Fill };
        ...
        /// <summary>
        /// Gets or Sets whether the view is already Vertical
        /// ex : 
        /// </summary>
