    ...
    public class CommentsViewModel : BaseViewModel
    {
...
#else
        private ReactionXF _selectedItem;
        public ObservableCollection<ReactionXF> Items { get; }
        public Command<ReactionXF> ItemTapped { get; }
#endif
...
#else
            Items = new ObservableCollection<ReactionXF>();
            ItemTapped = new Command<ReactionXF>(OnItemSelected);
#endif
        ...
        public async Task ExecuteLoadItemsCommand()
        {
            ...
            try
            {
                ...
                var items = await ReactionService.Instance.GetReactionsAsync(reactionQueryValues);
                ...
                var itemsXF = JsonConvert.DeserializeObject<ResultData<ReactionXF>>(JsonConvert.SerializeObject(items));
        ...
        ReactionXF ProcessItem(ReactionXF item)
        {
...
#else
        public ReactionXF SelectedItem
#endif
        {
            get => _selectedItem;
            set
...
#else
        async void OnItemSelected(ReactionXF item)
#endif
        {
            if (item == null)
                return;
